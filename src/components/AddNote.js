...
const AddNote = (props) => {
    ...
    const [note, setNote] = useState({ title: "", description: "", tag: "", images: [] });
    ...
    const handleFileChange = (e) => {
        setNote({ ...note, images: Array.from(e.target.files) });
    };
        ...
        <div className="container my-3">
            ...
            <form>
                <div className="mb-3">
                    ...
                    <input type="text" name='title' onChange={onChange} value={note.title} minLength={5} required className="form-control" id="title" />
                </div>
                <div className="mb-3">
